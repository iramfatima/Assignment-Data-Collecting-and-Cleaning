...
colnames(finaldata) <- paste("Average", colnames(finaldata), sep = "_")
colnames(finaldata)[colnames(finaldata)=="Average_Performed_Activity"] <- "Performed_Activity"
colnames(finaldata)[colnames(finaldata)=="Average_SubjectID"] <- "SubjectID"
