"Performed_Activity" This column represents the activity label performed by a subject. The list of all actvities are as follows
1 WALKING
2 WALKING_UPSTAIRS
...
"SubjectID" is the identifier for each subject who performed a particular activity. There are 30 subjects involved in this dataset and their ids ranges from 1-30
   
The remaining column of the dataset shows the mean and standard dedivation of the following measures from the origial dataset as shown below.
...
Moreover,I added the word Average with each column as each column represents the average of each variable for each actvitty and each subject.
